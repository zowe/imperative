...
export class SyntaxValidator {
    ...
    private validateSyntax(commandArguments: Arguments, responseObject: CommandResponse): boolean {
        ...
        /**
         * Reject unknown positional options
         */
        if (this.mCommandDefinition.type === "command" &&
            ...
            this.mLogger.trace("no unknown positionals. Length of positional options was: %s. Contents of _ were %s, Expected " +
        ...
        /**
         * Check for missing positional options. We can enforce this at the "yargs" definition level, however
