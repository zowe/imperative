...
// "Mocked" version of the handler parameters for a delete profile command
const deleteProfileParms: any = {
    arguments: {
        $0: "zowe",
        _: ["profiles", "delete", "zosmf-profile", "ProfileToDelete"],
    },
    response: {
        data: {
...
describe("delete profile handler", () => {
    ...
    describe("successful operation", () => {
        it("should delete a profile", async () => {
            ...
            expect(logText).toContain("was successfully deleted");
        });
    });
