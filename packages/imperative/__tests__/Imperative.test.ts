...
describe("Imperative", () => {
    ...
    describe("addAutoGeneratedCommands", () => {
        ...
        jest.mock("../src/profiles/builders/CompleteProfilesGroupBuilder", () => ({
                CompleteProfilesGroupBuilder: class {
                    public static getProfileGroup() {
                        mockGetProfileGroup();
                    }
                }
            })
