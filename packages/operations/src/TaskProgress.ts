...
export class TaskProgress {
    public static readonly ZERO_PERCENT = 0;
    public static readonly TEN_PERCENT = 10;
    public static readonly TWENTY_PERCENT = 20;
    ...
    public static readonly ONE_HUNDRED_PERCENT = 100;
}
