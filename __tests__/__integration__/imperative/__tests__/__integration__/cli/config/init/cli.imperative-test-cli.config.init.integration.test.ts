...
describe("imperative-test-cli config init", () => {
    ...
    it("should display the help", () => {
        ...
        expect(response.output.toString()).toContain(`Initialize config files. Defaults to initializing "imperative-test-cli.config.json" in the`);
        expect(response.output.toString()).toContain(`current working directory unless otherwise specified. Use "--user" to init`);
        expect(response.output.toString()).toContain(`"imperative-test-cli.config.user.json". Use "--global" to initialize the configuration`);
